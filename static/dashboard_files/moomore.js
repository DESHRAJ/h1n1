...
// Load this file's selection again by visiting: http://mootools.net/more/d5b21f2a1ef9e4f3df55d5cba6438170 
// Or build this file again with packager using: packager build More/Number.Format More/Element.Measure More/Form.Request More/Form.Validator More/Form.Validator.Inline More/Fx.Elements More/Fx.Accordion More/Fx.Scroll More/Fx.Slide More/Fx.Sort More/Drag.Move More/Slider More/Request.JSONP More/Assets More/Color
/*
---
copyrights:
...
}a.decimals=b!=null?b:(a.decimals==null?2:a.decimals);return this.format(a);}});(function(){var b=function(e,d){var f=[];Object.each(d,function(g){Object.each(g,function(h){e.each(function(i){f.push(i+"-"+h+(i=="border"?"-width":""));
...
e["total"+k]=j;i.each(function(m){var l=c(m,g);e["computed"+m.capitalize()]=l;e["total"+k]+=l;});},this);return Object.append(e,g);}});})();Class.Mutators.Binds=function(a){if(!this.prototype.initialize){this.implement("initialize",function(){});
